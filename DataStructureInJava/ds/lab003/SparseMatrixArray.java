	...
	*/
	...
	SparseMatrix Add(SparseMatrix b) {
		...
		while((aPos < terms) && (bPos < b.terms))
		{
			...
			{
				c.StoreSum(b.smArray[bPos].value, b.smArray[bPos].row, b.smArray[bPos].col);
				bPos++;
			}
			else
			{
				c.StoreSum(smArray[aPos].value, smArray[aPos].row, smArray[aPos].col);
				aPos++;
			}
